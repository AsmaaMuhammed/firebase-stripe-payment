...
Further reading:
 - Stripe Node API: https://stripe.com/docs/api/node  or https://github.com/stripe/stripe-node#network-retries
 -https://github.com/firebase/functions-samples/issues/478
